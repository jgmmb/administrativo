...
<html lang="en" class="no-focus">
    <head>
        ...
        <title>Registrase | Jm Computers</title>
    ...
    <body>
        ...
        <div id="page-container" class="main-content-boxed">
            ...
            <main id="main-container">
                <!-- Page Content -->
                <div class="bg-image" style="background-image: url('../public/assets/img/photos/photo20@2x.jpg');">
                        ...
                        <div class="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
                            <div class="p-30 invisible" data-toggle="appear">
                                ...
                                <p class="font-size-h5 text-white">
                                    <i class="fa fa-angles-right"></i> www.jmcomputers.com
                                </p>
                            ...
                            <div class="content content-full">
                                ...
                                <div class="px-30 py-10">
                                    <a class="link-effect font-w700" href="index.php">
                                        ...
                                        <span class="font-size-xl text-primary-dark">Jm </span><span class="font-size-xl">Computers</span>
                                    </a>
                                    <h1 class="h3 font-w700 mt-30 mb-10">Crear Cuenta</h1>
                                    <h2 class="h5 font-w400 text-muted mb-0">Complete todos los campos</h2>
                                </div>
                                <div class="px-30">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <div class="form-material floating">
                                                    ...
                                                    <input type="email" class="form-control" id="usu_correo" name="usu_correo" autocomplete="on" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <div class="form-material floating">
                                                    ...
                                                    <input type="password" class="form-control" id="usu_pass1" name="usu_pass1" autocomplete="new-password" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-12">
                                                <div class="form-material floating">
                                                    ...
                                                    <input type="password" class="form-control" id="usu_pass2" name="usu_pass2" autocomplete="new-password" required>
                                                </div>
                                            </div>
                                        </div>
