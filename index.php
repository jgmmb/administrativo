...
<html lang="en" class="no-focus">
    <head>
        ...
        <title>Acceso Jm Computers</title>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material floating">
                                                ...
                                                <input type="email" class="form-control" id="correo" name="correo" autocomplete="on" require >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <div class="form-material floating">
                                                ...
                                                <input type="password" class="form-control" id="password" name="password" autocomplete="current-password" require>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-12">
                                            <label class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="login-remember-me" name="login-remember-me" require>
